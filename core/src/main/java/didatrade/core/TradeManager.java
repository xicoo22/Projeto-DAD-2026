...
public class TradeManager {
	...
	public synchronized boolean sell(int user_id, int fraction) {
		...
		System.out.println("\n\t in sell for user " + user_id + " with stock " + user.getStock() + " selling " + fraction
				+ "%  = " + n_items + " items.\n");
	...
	public synchronized boolean acquire(int user_id, int fraction) {
		...
		System.out.println("\n\t in acquire for user " + user_id + " with balance " + user.getBalance() + " acquiring "
				+ fraction + "%  = " + n_items + " items.\n");
